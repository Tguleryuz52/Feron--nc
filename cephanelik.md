...
4. Anasayfa: Tam ekran loopa giren video background. Alt ortada dinamik New York yerel saati gösteren küçük bir ibare, sol altta yüzen bir Spotify (müzik çalar) widget'ı andıran ui.
5. Shop Grid: Masaüstünde 3 sütun. Ürün görselleri transparan olduğu için arka plan renkleriyle destekle (object-fit: contain kullanarak yerleştir, Fossil'in 4:5 dikey zorlaması resimlerimi kesmemeli ve boşlukları güzelce renklerle doldurmalı). Sol üstünde siyah "NEW" badge'i olacak.
